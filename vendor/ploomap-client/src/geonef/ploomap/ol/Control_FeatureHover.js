...
/**
 * Class: OpenLayers.Control.FeatureHover
 *
 *
 * Inherits from:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.FeatureHover = OpenLayers.Class(OpenLayers.Control,
{
  ...
  /**
   * Constructor: <OpenLayers.Control.FeatureHover>
   *
   * Parameters:
...
/*  selectHandler: function(name) {
  ...
  CLASS_NAME: "OpenLayers.Control.FeatureHover"
});
