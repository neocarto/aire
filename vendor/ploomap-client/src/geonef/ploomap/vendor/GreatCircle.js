...
dojo.provide('geonef.ploomap.vendor.GreatCircle');

//
// Taken from example on:
// http://gis.ibbeck.de/ginfo/apps/OLExamples/OL26/examples/gc_example.html
//
// Original URL of this file:
// http://gis.ibbeck.de/ginfo/apps/OLExamples/OL26/examples/javascript/greatcirclemod.js
//
...
geo.GreatCircle.prototype.toPoints = function (startLon, endLon, projection) {
   ...
   var k = 0;                            // waypoints index
	...
	while( lon <= endLon) {
		...
		waypoints[k++] = new OpenLayers.Geometry.Point (lon * geo.RAD2DEG, lat * geo.RAD2DEG).transform(new OpenLayers.Projection("EPSG:4326"), projection);
...
geo.GreatCircle.prototype.toLineString = function (startLon, endLon, projection) {
  var waypoints = this.toPoints(startLon, endLon, projection);
...
//
// Copy from http://gis.ibbeck.de/ginfo/apps/OLExamples/OL26/examples/javascript/gc_example.js
