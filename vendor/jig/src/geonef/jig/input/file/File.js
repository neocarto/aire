dojo.provide('geonef.jig.input.file.File');

dojo.require('dijit._Widget');
dojo.require('dijit._Templated');
dojo.require('geonef.jig.input.file.Upload');

dojo.declare('geonef.jig.input.file.File', [ dijit._Widget, dijit._Templated ],
{
  // Summary:
  ...
  templatePath: dojo.moduleUrl('geonef.jig.input.file', 'templates/File.html'),
