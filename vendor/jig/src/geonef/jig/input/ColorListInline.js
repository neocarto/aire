...
dojo.provide('geonef.jig.input.ColorListInline');
...
dojo.declare('geonef.jig.input.ColorListInline',
             [ dijit._Widget, dijit._Templated, geonef.jig.input._Container ],
{
  ...
  templateString: dojo.cache('geonef.jig.input', 'templates/ColorListInline.html'),
