...
/**
 * Class: OpenLayers.Control.PloomapFeature
 *
 *
 * Inherits from:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.PloomapFeature = OpenLayers.Class(OpenLayers.Control,
{
  ...
  /**
   * Constructor: <OpenLayers.Control.PloomapFeature>
   *
   * Parameters:
...
/*  selectHandler: function(name) {
  ...
  CLASS_NAME: "OpenLayers.Control.PloomapFeature"
});
