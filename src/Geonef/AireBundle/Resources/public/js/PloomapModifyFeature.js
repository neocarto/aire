...
/**
 * Class: OpenLayers.Control.PloomapModifyFeature
 * Control to modify features.  When activated, a click renders the vertices
 *     of a feature - these vertices can then be dragged.  By default, the
 *     delete key will delete the vertex under the mouse.  New features are
 *     added by dragging "virtual vertices" between vertices.  Create a new
 *     control with the <OpenLayers.Control.PloomapModifyFeature> constructor.
 *
 * Inherits From:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.PloomapModifyFeature = OpenLayers.Class(OpenLayers.Control, {
     ...
     *      OpenLayers.Control.PloomapModifyFeature.RESHAPE. To set the mode to a
     *      combination of options, use the | operator. or example, to allow
     *      the control to both resize and rotate features, use the following
     *      syntax
     * (code)
     * control.mode = OpenLayers.Control.PloomapModifyFeature.RESIZE |
     *                OpenLayers.Control.PloomapModifyFeature.ROTATE;
     *  (end)
     */
    mode: null,
    ...
    /**
     * Constructor: OpenLayers.Control.PloomapModifyFeature
    ...
    initialize: function(layer, options) {
        ...
        this.mode = OpenLayers.Control.PloomapModifyFeature.RESHAPE;
...
//         });
    ...
    resetVertices: function() {
        ...
        if(this.feature &&
           this.feature.geometry.CLASS_NAME != "OpenLayers.Geometry.Point") {
            if((this.mode & OpenLayers.Control.PloomapModifyFeature.DRAG)) {
                this.collectDragHandle();
            }
            if((this.mode & (OpenLayers.Control.PloomapModifyFeature.ROTATE |
                             OpenLayers.Control.PloomapModifyFeature.RESIZE))) {
                this.collectRadiusHandle();
            }
            if((this.mode & OpenLayers.Control.PloomapModifyFeature.RESHAPE)) {
    ...
    collectRadiusHandle: function() {
        ...
        var resize = (this.mode & OpenLayers.Control.PloomapModifyFeature.RESIZE);
        var rotate = (this.mode & OpenLayers.Control.PloomapModifyFeature.ROTATE);
    ...
    CLASS_NAME: "OpenLayers.Control.PloomapModifyFeature"
});
 ...
 */
OpenLayers.Control.PloomapModifyFeature.RESHAPE = 1;
/**
 * Constant: RESIZE
 * {Integer} Constant used to make the control work in resize mode
 */
OpenLayers.Control.PloomapModifyFeature.RESIZE = 2;
/**
 * Constant: ROTATE
 * {Integer} Constant used to make the control work in rotate mode
 */
OpenLayers.Control.PloomapModifyFeature.ROTATE = 4;
/**
 * Constant: DRAG
 * {Integer} Constant used to make the control work in drag mode
 */
OpenLayers.Control.PloomapModifyFeature.DRAG = 8;
