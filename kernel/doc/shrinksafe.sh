...
_b=`dirname $_a`
_c=`dirname $_b`
root_site_dir=`dirname $_c`


release_name=$app_name
profile_path=$root_site_dir/$app_name/$app_name/doc/$app_name.profile.js
release_dir=$root_site_dir/$app_name/$app_name/cache/shrinksafe-release
